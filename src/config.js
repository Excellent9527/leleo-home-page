const config = {
	...
	metaData: {
		title: '嘉多宝的赛博小窝🎉',
		description: '欢迎来到嘉多宝的奇妙世界！',
		keywords: '嘉多宝,嘉多宝,个人主页,个人网站',
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				...
				"url": "https://wp.upx8.com/api.php?content=动漫",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "pic",
			"datainfo": {
				...
				"url": "https://t.alcy.cc/ai"  //同理，随机移动端壁纸："url":"https://t.mwm.moe/mp"
			}
		}
	...
	//极坐标图数据
	polarChart: {
		skills: ['吹牛', '摸鱼', '摆烂', '发癫', '抽象', '八卦', '对线', '唱跳', 'rap篮球', '练习生', '只因你太美'],
	...
	projectcards: [
		{ go: "🚀 点击前往", img: "/img/background1.jpg", title: "Project 1", subtitle: "1,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "🗂️ 点击前往", img: "/img/background2.jpg", title: "Project 2", subtitle: "2,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "📝 点击前往", img: "/img/background3.jpg", title: "Project 3", subtitle: "3,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "👍 点击前往", img: "/img/background4.jpg", title: "Project 4", subtitle: "4,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "🗃 点击前往", img: "/img/background5.jpg", title: "Project 5", subtitle: "5,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "🎨 点击前往", img: "/img/background6.jpg", title: "Project 6", subtitle: "6,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "💍 点击前往", img: "/img/background7.jpg", title: "Project 7", subtitle: "7,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
		{ go: "🔍 点击前往", img: "/img/background8.jpg", title: "Project 8", subtitle: "8,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: false },
	],
